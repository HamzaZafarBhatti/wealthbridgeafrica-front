...
@section('content')
            ...
            <div class="story__wrapper">
                <div class="story__thumb">
                    <div class="story__thumb-inner" data-aos="fade-up" data-aos-duration="800">
                        <img src="{{ asset('assets/images/about/4.png') }}" alt="story-image">
                        <div class="story__thumb-playbtn">
                            <a href="https://www.youtube.com/watch?v=uJSgaPIvgKk&ab_channel=FreeTemplates"
                                data-fslightbox><i class="fa-solid fa-circle-play"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="about__content" data-aos="fade-left" data-aos-duration="800">
                            <div class="about__content-inner">
                                ...
                                <p class="mb-0">Hey there! So glad you stopped by to Meet Our Company. Don't miss out on
                                    this
                                    opportunity to learn about what we do and the amazing team that makes it all happen! Our
                                    company is
                                    all about creating innovative solutions and providing top-notch services to our clients.
                                    From start to
    ...
    <section class="roadmap roadmap--style1 padding-top  padding-bottom bg-color" id="roadmap">
                            ...
                            <div class="roadmap__item-inner">
                                <div class="roadmap__item-content">
                                    ...
                                    <p>Project research is the backbone of any successful project. It involves gathering
                                        information,
                                        setting objectives, and analyzing data to ensure the project is achievable. Without
                                        proper research,
                        ...
                        <div class="roadmap__item roadmap__item--style2 ms-auto me-md-4 aos-init aos-animate"
                            ...
                            <div class="roadmap__item-inner">
                                <div class="roadmap__item-content">
                                    ...
                                    <p>Hey there! Just wanted to throw out a framing idea for our upcoming project. Let's
                                        start with the
                                        big picture and then work our way down to the details. This way we ensure our vision
                                        stays on track
                        ...
                        <div class="roadmap__item ms-md-4 aos-init" data-aos="fade-left" data-aos-duration="800">
                            <div class="roadmap__item-inner">
                                <div class="roadmap__item-content">
                                    ...
                                    <p>Hey guys, just wanted to share my design first draft! I went for a minimalist look
                                        with a pop of
                                        color. What do you think? Open to any suggestions or feedback. Can't wait to see how
                                        this turns out
                        ...
                        <div class="roadmap__item roadmap__item--style2 ms-auto me-md-4 aos-init" data-aos="fade-right"
                            ...
                            <div class="roadmap__item-inner">
                                <div class="roadmap__item-content">
                                    ...
                                    <p>So after lots of reiterations, and endless tweaking, we finally landed on the final
                                        design. It's
                        ...
                        <div class="roadmap__item ms-md-4 aos-init" data-aos="fade-left" data-aos-duration="800">
                            <div class="roadmap__item-inner">
                                <div class="roadmap__item-content">
                                    ...
                                    <p>So we're deep in project development here, and things are coming along nicely. We've
                                        got a solid
                        ...
                        <div class="roadmap__item roadmap__item--style2 ms-auto me-md-4 aos-init" data-aos="fade-right"
                            ...
                            <div class="roadmap__item-inner">
                                <div class="roadmap__item-content">
                                    ...
                                    <p>Alright folks, it's time to get this project off the ground! We've been talking about
                                        it for weeks,
                                        and now it's time to launch. We've got all the pieces in place, so let's get to work
                                        and make this
                                        thing happen!</p>
                                </div>
                            </div>
        ...
        <div class="roadmap__shape">
            ...
            <span class="roadmap__shape-item roadmap__shape-item--2"> <img src="{{ asset('assets/images/icon/1.png') }}"
                    alt="shape-icon">
            </span>
        </div>
    </section>
                ...
                <div class="cta__newsletter justify-content-center">
                    <div class="cta__newsletter-inner" data-aos="fade-up" data-aos-duration="1000">
                        ...
                        <div class="cta__subscribe">
                            ...
                            <p>Hey! Are you tired of missing out on our updates? Subscribe to our news now and stay in the
                                loop!</p>
