...
<section class="banner banner--style1">
    <div class="banner__bg">
        <div class="banner__bg-element">
            <img src="{{ asset('assets/images/banner/home1/bg.png') }}" alt="section-bg-element"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg') }}" width="24" height="24"
                                        ...
                                        <g clip-path="url(#clip0_1397_814)">
                                            <path
                                                ...
                                                stroke="#0A4FD5" stroke-width="1.5" stroke-linecap="round"
                                                stroke-linejoin="round" />
                                        </g>
                                        <rect x="-0.75" y="0.75" width="22.5" height="22.5" rx="11.25"
                                            transform="matrix(-1 0 0 1 22.5 0)" stroke="#0A4FD5" stroke-width="1.5" />
                                        <defs>
    ...
    <div class="banner__shape">
        <span class="banner__shape-item banner__shape-item--1"><img
                src="{{ asset('assets/images/banner/home1/4.png') }}" alt="shape icon"></span>
    </div>
