            ...
            <div class="cta__newsletter justify-content-center">
                <div class="cta__newsletter-inner cta__newsletter-inner--style2" data-aos="fade-up"
                    ...
                    <div class="cta__thumb">
                        <img src="https://wealthbridgeafrica.com/public/assets/images/icon/upload/3.png" alt="cta-thumb">
                    </div>
                    <div class="cta__subscribe">
                        <h2 class="mb-0"> <span>Subscribe</span> to WealthBridgeAfrica Latest Updates</h2>
                        <p>Stay in the loop with WealthBridgeAfrica! Get all the timely updates sent directly to your primary email.</p>
